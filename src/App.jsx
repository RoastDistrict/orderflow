...
// ─── SCAN SCREEN ──────────────────────────────────────────────
function ScanScreen({actorName,onBack,onConfirm,skuList,catList,buyerList=[],onAddAlias}){
    ...
    <div style={{flex:1,overflowY:"auto",padding:"20px 20px 40px"}}>
      ...
      {stage==="reviewing"&&ext&&<>
        ...
        {ext.sections.map((sec,sIdx)=><div key={sIdx} style={{marginBottom:20}}>
          ...
          {/* Save as Alias button — shown when OCR name differs from resolved buyer */}
...
export default function App(){
  ...
  if(screen==="staff-scan")return <ScanScreen actorName={actorName} onBack={()=>setScreen("staff-app")} onConfirm={o=>{addOrder(o);setScreen("staff-app");}} skuList={enrichedSkuList} catList={catList} buyerList={buyerList} onAddAlias={addAlias}/>;
  if(screen==="staff-app"){
