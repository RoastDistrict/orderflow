...
export default function App(){
  ...
  useEffect(()=>{
    ...
    const unsubAdminPw=onValue(adminPwRef,snap=>{
      const val=snap.val();
      if(val===null||val===undefined){set(ref(db,"settings/adminPassword"),"6666");setAdminPassword("6666");}
  ...
  const moveSkuToLive=(orderId,sIdx,iIdx)=>{
    ...
    set(ref(db,`orders/${orderId}`),remaining);
  ...
  const updateAdminPassword=(pw)=>set(ref(db,"settings/adminPassword"),String(pw));
